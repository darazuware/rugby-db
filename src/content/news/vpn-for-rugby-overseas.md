...
アメリカ・ヨーロッパ・オーストラリアなどではVPNの使用は一般的で、セキュリティツールとして広く普及しています。法的な問題もほぼありません。ただし現地でも独自のラグビー配信サービスがあるため、[日本代表](/national-teams/japan/)やリーグワンを観たい目的に絞ってVPNを使うという使い方になります。

...
日本代表が初めてテストマッチ（国際試合）を行ったのは1930年。バンクーバー遠征で[カナダ代表](/national-teams/canada/)と対戦（3-3で引き分け）し、その歴史が始まりました。1932年には来日したカナダ代表を国内で初めて迎え撃っています。当時の日本代表は体格で劣るものの、素早い動きと組織力で戦うスタイルを模索していました。

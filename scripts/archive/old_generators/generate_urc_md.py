...
# 設定
CSV_PATH = 'data_sources/urc_full.csv'
...
def main():
    ...
    with open(CSV_PATH, mode='r', encoding='utf-8-sig') as f:
        ...
        for i, row in enumerate(reader):
            ...
            # URL から末尾の ID を抽出 (例: https://all.rugby/player/allan-alaalatoa -> allan-alaalatoa)
            url_id = scraped_url.split('/')[-1] if scraped_url else f"player-{i+30000}"
            slug = f"{url_id}-urc"
